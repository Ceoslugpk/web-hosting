...
export const Hero = () => {
  return (
    <section className="bg-white w-full max-md:max-w-full overflow-hidden">
        ...
        <div className="relative w-full max-w-[1394px] max-md:max-w-full">
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
            <div className="w-6/12 max-md:w-full max-md:ml-0">
              <div className="relative flex w-full flex-col self-stretch my-auto max-md:max-w-full max-md:mt-10 animate-slide-in-right">
                ...
                <div className="self-stretch text-[52px] text-[#0E2954] font-bold leading-[52px] mt-[18px] pr-11 max-md:max-w-full max-md:text-[40px] max-md:leading-[44px] max-md:pr-5">
                  ...
                  <span className="text-[#4E4FEB] hover:text-[#3a3bdc] transition-colors">Business</span>
                  <br />
                ...
                <div className="flex w-[303px] max-w-full items-stretch gap-[19px] text-sm font-semibold text-center capitalize leading-[14px] mt-[23px]">
                  <button className="self-stretch rounded bg-[#4E4FEB] hover:bg-[#3a3bdc] transition-colors shadow-[-4px_4px_0px_rgba(237,237,253,1)] hover:shadow-[-2px_2px_0px_rgba(237,237,253,1)] border text-white px-[19px] py-[15px] border-[rgba(227,233,237,1)]">
                    Choose a plan
                  </button>
                  <button className="self-stretch rounded bg-white hover:bg-gray-50 transition-colors shadow-[-4px_4px_0px_rgba(237,237,253,1)] hover:shadow-[-2px_2px_0px_rgba(237,237,253,1)] border text-[#0E2954] px-[19px] py-[15px] border-[rgba(227,233,237,1)]">
                    Get More power
                  </button>
                </div>
                <div className="flex w-[383px] max-w-full gap-5 justify-between mt-[43px] max-md:mt-10">
                  <div className="flex flex-col items-stretch hover:transform hover:scale-105 transition-transform">
                  ...
                  <div className="self-stretch flex flex-col items-stretch hover:transform hover:scale-105 transition-transform">
                    <h3 className="text-[#0E2954] text-base font-bold leading-[19.2px] capitalize">
                      48+
                    </h3>
            ...
            <div className="w-6/12 ml-5 max-md:w-full max-md:ml-0">
              <div className="relative flex w-full flex-col items-stretch text-base text-[#0E2954] font-bold capitalize leading-[19.2px] max-md:max-w-full max-md:mt-10 animate-fade-in">
                <img
                  loading="lazy"
                  ...
                  className="aspect-[1.29] object-contain w-full max-md:max-w-full hover:transform hover:scale-105 transition-transform"
                  alt="Hosting illustration"
                />
                <div className="self-center flex w-[277px] max-w-full items-stretch gap-3 mt-5 hover:transform hover:scale-105 transition-transform">
                  <img
                    loading="lazy"
